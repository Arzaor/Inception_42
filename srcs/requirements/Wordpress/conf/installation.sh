...
wp core install --allow-root --url=${DOMAIN_NAME} --title="Titre" --admin_user=${WORDPRESS_ADMIN} --admin_password=${WORDPRESS_ADMIN_PASS} --admin_email="user42@user.com" --path="/var/www/html"
